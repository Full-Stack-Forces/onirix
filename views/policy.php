...
<div id="policy" class="container mx-auto mt-10 mb-20">
    <section class="text-justify">
        <div class="my-2">
            <h2>Article 1 : Objet</h2>
            <p>Les présentes CGU ou Conditions Générales d'Utilisation encadrent juridiquement l'utilisation des services du site fullstackforces (ci-après dénommé " le site ").
                Constituant le contrat entre la société La Petite Perle, l'Utilisateur, l'accès au site doit être précédé de l'acceptation de ces CGU. L'accès à cette plateforme signifie l'acceptation des présentes CGU.</p>
        </div>

        <div class="my-2">
            <h2>Article 2 : Mentions légales</h2>
            <p>L'édition du site fullstackforces est assurée par la société La Petite Perle inscrite au RCS sous le numéro 451 432 228, dont le siège social est localisé au 3 Rue Docteur Joubert, 59110, La Madeleine, France Métropolitaine.
                L'hébergeur du site fullstackforc.lareunion.webcup.hodi.host/ est la société LHW, sise au 5 Rue Keller, 59100 Roubaix, France.</p>
        </div>

        <div class="my-2">
            <h2>Article 3 : Accès au site</h2>
            <p>Le site fullstackforces permet d'accéder gratuitement aux services suivants :
                Interprétation de rêves et prédiction de l'avenir.
        ...
        <div class="my-2">
            ...
            <p>Les marques, logos ainsi que les contenus du site fullstackforces (illustrations graphiques, textes...) sont protégés par le Code de la propriété intellectuelle et par le droit d'auteur.
        ...
        <div class="my-2">
            ...
            <p>Bien que les informations publiées sur le site soient réputées fiables, le site se réserve la faculté d'une non-garantie de la fiabilité des sources.
                ...
                La garantie totale de la sécurité et la confidentialité des données n'est pas assurée par le site. Cependant, le site s'engage à mettre en &oelig;uvre toutes les méthodes requises pour le faire au mieux.</p>
        </div>
        ...
        <div class="my-2">
            ...
            <p>Lors des visites sur le site, l'installation automatique d'un cookie sur le logiciel de navigation de l'Utilisateur peut survenir.
                ...
                L'information présente dans les cookies est utilisée pour améliorer les performances de navigation sur le site fullstackforc.lareunion.webcup.hodi.host/.
        ...
        <div class="my-2">
            ...
            <p>Le site fullstackforces permet aux membres de publier des commentaires.
