    ...
    <div class="w-full glass rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0">
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form action="check-login" method="POST" class="space-y-4 md:space-y-6">
                <div>
                    <label for="username" class="block mb-2 text-sm font-medium text-cyan-950 dark:text-white">Identifiant</label>
                ...
                <div>
                    <label for="password" class="block mb-2 text-sm font-medium text-cyan-950 dark:text-white">Mot de passe</label>
                ...
                <button type="submit" class="w-full text-white bg-cyan-950 hover:bg-cyan-900 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Se connecter</button>
